...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassPeriod.label'
        db.add_column('BBCore_classperiod', 'label', self.gf('django.db.models.fields.CharField')(default=None, max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClassPeriod.label'
        db.delete_column('BBCore_classperiod', 'label')
    ...
    models = {
        ...
        'BBCore.dayschedule': {
            'Meta': {'object_name': 'DaySchedule'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'periods': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BBCore.ClassPeriod']", 'symmetrical': 'False'})
        },
        'BBCore.post': {
        ...
        'BBCore.schoolday': {
            'Meta': {'object_name': 'Schoolday'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['BBCore.DaySchedule']"})
        },
        'BBCore.section': {
            'Meta': {'object_name': 'Section'},
            'classes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['BBCore.ClassPeriod']", 'symmetrical': 'False'}),
